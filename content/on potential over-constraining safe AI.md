...
It seems to me that multi-agent systems (could be related to culture[^5][^6]) should be part of the solution, which can improve the resiliency a lot. 
...
[^6]: https://x.com/JoHenrich/status/1903179904033673440